...
if command -v curl >/dev/null 2>&1; then
  source <(curl -fsSL https://raw.githubusercontent.com/zackwithak13/ProxmoxVE/refs/heads/feat/uhf-server-lxc/misc/core.func)
  load_functions
  #echo "(create-lxc.sh) Loaded core.func via curl"
elif command -v wget >/dev/null 2>&1; then
  source <(wget -qO- https://raw.githubusercontent.com/zackwithak13/ProxmoxVE/refs/heads/feat/uhf-server-lxc/misc/core.func)
  load_functions
